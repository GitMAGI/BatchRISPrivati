        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                foreach (DataRow rich in richs.Rows)
                {
                    ...
                    string insertquery = "insert into [GR].[dbo].[EPIS] (EPISPAZI, EPISDAIN, EPISDAFI, EPISTIPO, EPISCHIU, EPISREPA) VALUES (@epispazi, @episdain, @episdafi, @epistipo, @epischiu, @episrepa); select @@identity AS episidid;";
